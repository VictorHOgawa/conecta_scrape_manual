...
# with open("Spiders/CSS_Selectors/Df/Df_GazetaDoPovo.json") as f:
#     search_terms = json.load(f)

# main_url = "https://www.gazetadopovo.com.br/ultimas-noticias/"

# class GazetaDoPovoSpider(scrapy.Spider):
#     name = "Df_GazetaDoPovo"
#     start_urls = ["https://www.gazetadopovo.com.br/ultimas-noticias/"]
#     INCREMENT = 1
...
#             self.INCREMENT += 1
#         next_page = f"https://www.gazetadopovo.com.br/ultimas-noticias/{self.INCREMENT}"
