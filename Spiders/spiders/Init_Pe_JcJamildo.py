...
# site_id = "7d5e6909-3d5b-41c9-a99d-862773b437e6"

# request = requests.get(f"{os.environ['API_IP']}/scrape/news/{site_id}")
# search_words = request.json()

# with open("Spiders/CSS_Selectors/PE/Pe_JcJamildo.json") as f:
...
#         self.INCREMENT += 1
#         next_page = f"https://jc.ne10.uol.com.br/index.php?id=/readMore.php&cd_sesit=1300&p={self.INCREMENT}"
