...
# request = requests.get(f"{os.environ['API_IP']}/scrape/news/0ea8ae61-94c1-4994-abe6-5868b927f766")
# search_words = request.json()

# with open("Spiders/CSS_Selectors/Df/Df_G1.json") as f:
...
#     name = "Df_G1"
#     start_urls = ["https://g1.globo.com/politica/index/feed/pagina-1.ghtml"]
#     INCREMENT = 1
