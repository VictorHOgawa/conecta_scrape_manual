...
# site_id = "42d090d4-414c-480e-901f-0bc37a926f62"

# request = requests.get(f"{os.environ['API_IP']}/scrape/news/{site_id}")
# search_words = request.json()

# with open("Spiders/CSS_Selectors/PE/Pe_Jc.json") as f:
#     search_terms = json.load(f)

# main_url = "https://jc.ne10.uol.com.br/index.php?id=/readMore.php&cd_sesit=356&p=1"

# class JcSpider(scrapy.Spider):
#     name = "Pe_Jc"
#     start_urls = ["https://jc.ne10.uol.com.br/index.php?id=/readMore.php&cd_sesit=356&p=1"]
#     INCREMENT = 1
    
#     def parse(self, response):
#         for article in response.css(search_terms['article']):
#             link = article.css(search_terms['link']).get()
#             yield Request(f"https://jc.ne10.uol.com.br{link}", callback=self.parse_article, priority=1)
#         self.INCREMENT += 1
#         next_page = f"https://jc.ne10.uol.com.br/index.php?id=/readMore.php&cd_sesit=356&p={self.INCREMENT}"
