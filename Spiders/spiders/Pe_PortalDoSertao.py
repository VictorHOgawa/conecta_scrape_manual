...
# site_id = "b40db2f2-e786-4a87-8145-f95578fa4ecc"

# request = requests.get(f"{os.environ['API_IP']}/scrape/news/{site_id}")
# search_words = request.json()

# with open("Spiders/CSS_Selectors/PE/Pe_PortalDoSertao.json") as f:
...
#         self.INCREMENT += 1
#         next_page = f"https://www.jornalportaldosertao.com.br/page/{self.INCREMENT}"
