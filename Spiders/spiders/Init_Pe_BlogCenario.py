...
# site_id = "b5d25072-6962-49b8-9a98-bd1886667233"

# request = requests.get(f"{os.environ['API_IP']}/scrape/news/{site_id}")
# search_words = request.json()

# with open("Spiders/CSS_Selectors/PE/Pe_BlogCenario.json") as f:
...
#         self.INCREMENT += 1
#         next_page = f"https://blogcenario.com.br/page/{self.INCREMENT}"
